...
This repo includes "Claude skills": reusable, file-based workflows stored as Markdown. They are designed to work in *any* AI tool that can read files (Gemini CLI, Codex CLI, Cursor, etc.).
